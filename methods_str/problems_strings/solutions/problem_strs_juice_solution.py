...
Ідентифікатор складається з трьох перших букв кожного слова назви фрукта і об'ему упакування.
...
def get_drink_id(item_name, volume):
	...
	for word in item_name.split():
		juice_label += word[:3].upper()
	volume_label = volume.rstrip(' ml')
	id = f'{juice_label}{volume_label}'
	return id
