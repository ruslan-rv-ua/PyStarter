...
Будемо називати даблтоном натуральне число, яке записується з використанням лише двох різних цифр.
Наприклад числа-даблтони: 23, 35, 100, 12121.
Не даблтони: 123, 9980.
Реалізуйте функцію next_doubleton(num).
Функція отримує натуральне число num.
Функція повертає найближче число-даблтон більше за num.
'''
