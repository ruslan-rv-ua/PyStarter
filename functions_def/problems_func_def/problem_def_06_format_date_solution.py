...
Реалізуйте функцію format_date(), яка приймає на вхід три цілих числа:
день, місяць та рік,
...
assert format_date(30, 2, 1953) == '1953-02-30'
assert format_date(30, 12, 1953) == '1953-12-30'
assert format_date(3, 2, 1953) == '1953-02-03'
assert format_date(1, 1, 1) == '0001-01-01'
assert format_date(1, 1, 101) == '0101-01-01'