...
Коли усі значення закінчаться, то при черговому та всіх наступних викликах цей метод має "піднімати" виняток `StopIteration`
...
Тепер спробуємо скористатись нашою лічилочкою:
...
Тепер можемо зручно ітеруватися по ряду Фібоначчі:
...
Потрібно створити список чисел Фібоначчі? Не проблема:
...
Проітеруватися по такому ряду чисел Фібоначчі можна лише один раз:
...
Виправимо цей недолік: створимо окремий клас, який представлятиме ряд чисел Фібоначчі, і окремий ітератор для нього.
...
Тепер можна створити ряд чисел Фібоначчі необхідної довжини та ітеруватися по ньому скільки завгодно:
