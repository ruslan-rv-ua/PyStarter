...
Ви можете <a href="./exceptions_tree.html" target="_blank">переглянути ієрархію винятків</a>, 
але повний і актуальний перелік усіх винятків можна знайти у документації, рекомендується ознайомитись з ним.
