...
Варто використовувати `namedtuple` коли:

- потрібна немутабельна структура даних
- потрібен легкий та зрозумілий контейнер для даних замість повноцінного класу
- важлива економія пам'яті та швидкодія
- дані представляють собою просту колекцію полів без методів
- потрібно зробити код більш читабельним порівняно з простими кортежами
- потрібно зберегти сумісність з кодом, що очікує кортежі
...
- [Документація Python: collections](https://docs.python.org/uk/3.13/library/collections.html)
