...
Хеш від цілого числа — зазвичай саме число, немає сенсу цілим числам співставляти інші цілі числа:

	>>> hash(42)
	42
	>>>

*Примітка: Для більшості цілих чисел у CPython хеш дорівнює самому числу, але це не гарантується специфікацією Python для всіх реалізацій і дуже великих чисел.*
...
*Примітка: Це специфічно для CPython і може змінюватися у майбутніх версіях або інших реалізаціях Python.*
...
*Примітка: Це приклад для CPython; у інших реалізаціях або версіях Python значення може відрізнятися.*
