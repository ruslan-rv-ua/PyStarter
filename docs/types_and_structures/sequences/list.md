...
Спискові включення (спискові вирази, list comprehension) — це потужний і зручний інструмент для створення списків з компактним синтаксисом. 
...
Змінні, які використовуються всередині спискового виразу, є локальними для цього виразу. 
Вони не перезаписують і не "забруднюють" змінні з тим самим ім'ям у зовнішньому просторі імен. Наприклад:
...
Переваги спискових включень:

*   **Компактність та читабельність:** Для простих операцій спискові включення часто є більш короткими та легшими для розуміння, ніж еквівалентні цикли `for`.
*   **Ефективність:** У багатьох випадках спискові включення можуть бути швидшими за традиційні цикли `for` через оптимізації на рівні інтерпретатора Python.
*   **Виразність:** Дозволяють чітко висловити намір створення нового списку на основі існуючої послідовності та умови.

Недоліки спискових включень:

*   **Складність для довгих виразів:** Якщо логіка створення списку є складною і включає багато умов або вкладених операцій, спискове включення може стати важким для читання та розуміння. У таких випадках краще використовувати традиційний цикл `for`.
*   **Відсутність побічних ефектів (зазвичай):** Спискові включення призначені для створення списків. Якщо вам потрібно виконати операції з побічними ефектами (наприклад, запис у файл, зміна зовнішніх змінних), краще використовувати цикли. Хоча технічно можливо викликати функції з побічними ефектами всередині спискового включення, це вважається поганою практикою, оскільки робить код менш передбачуваним.
*   **Не підходять для нескінченних послідовностей:** Спискові включення матеріалізують весь список у пам'яті. Для роботи з дуже великими або нескінченними послідовностями краще використовувати генераторні вирази, які обчислюють значення "на льоту".
...
- [Документація Python: Більше про списки (More on Lists)](https://docs.python.org/3/tutorial/datastructures.html#more-on-lists)
