...
**Екрановані послідовності** (escape sequences) в Python — це спеціальні послідовності символів, які починаються з зворотного слеша `\` і використовуються для представлення символів, які складно або неможливо ввести безпосередньо в рядок.
