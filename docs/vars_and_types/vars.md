...
Ім'я змінної має відповідати сутності даних, з якими вона пов'язана. 
...
- database_file_path (шлях до файла бази даних1)
...
З часом ви сформуєте правильні поняття іменування змінних.
...
- `integer_literal` та `float_literal` — змінні, не дивлячись на їх назви.
- `5` та `3.14` — літерали.
...
Інформація про вийняткову ситуацію починається рядком
...
Створіть дві змінні з іменами «перше число» і «друге число». Запишіть у першу змінну число 20, 
у другу — -100. 
...
Позначте на початку знаком "+" ті, які відповідають правилам іменування змінних в Python.
