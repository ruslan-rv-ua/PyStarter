...
# Мутабельні і немутабельні типи даних
...
А як же бути, якщо ми хочемо створити новий список, але дані взяти з іншого? 
У такому разі при створенні нового мутабельного об'єкта нам необхідно 
зкопіювати дані з іншого. 
Зріз завжди створює і повертає новий об'єкт. 
Скористаємось цим:
...
Також можна скористатись функцією `list()`:
...
Зрізи працюють трохи швидше, ніж функція `list()`.
