...
Інструкція 'del' дозволяє видаляти одне чи кілька посилань на об'єкт, у тому числі посилання у мутабельних колекціях, наприклад списках.
...
Зауважте: видаляються лише посилання на об'єкти а не самі об'єкти. 
...
Коли видаляється посилання на об'єкт, то у об'єкта зменьшується на 1 лічильник посилань. Але об'єкт залишається в пам'яті. Видаленням самого об'єкта з пам'яті займається вже збирач сміття.
...
Також можна видаляти елеменнти зі списка вказуючи зріз:
