...
- для термінала включити максимальний рівень проговорювання символів
- для термінала включити повідомлення при зміні динамічного контенту
...
1. Впевніться, що у вас відкритий редактор Notepad++ і його вікно активне
1. У меню NVDA вибрати "Конфігураційні профілі"
1. У відкрившомуся діалозі натиснути кнопку "Новий"
1. У відкрившомуся діалозі активувати радіокнопку "Поточний додаток (notepad++)" і натиснути кнопку "Гаразд"
1. Натиснути кнопку "Закрити"
1. Знову відкривши діалог "Конфігураційні профілі" впевніться що створений Вами профіль активний
1. У налаштуваннях NVDA вибрати категорію "Форматування документа"
1. Позначити прапорець "Номери рядків"
1. У комбінованому списку "Повідомляти про відступ рядка" обрати "Мовлення й сигнали".
1. Натиснути кнопку "Гаразд"
1. Натискаючи комбінацію клавіш **NVDA + P** встановити рівень проговорення символів "Усі"

У подальшому Ви можети змінити налаштування для профілю впевнившись попередньо що він активний.

Подібним способом створити профілі і зробити бажані налаштування для термінала, інтернет-браузера.

## Перегляд вмісту термінала за допомогою NVDA.
...
!!! warning "Увага!"
    Для того, щоб клавіші цифрового блоку (numpad) правильно виконували свої функції, режим Numlock повинен бути вимкненим. 

## Додатки до NVDA

Для більш комфортної роботи рекомендується встановити наступні додатки до NVDA:

- [Notepad++ text editor: accessibility enhancement](https://www.nvdaukr.online/2023/09/notepad.html) — поліпшення доступності текстового редактора Notepad++.

## Завдання

1. Виконайте необхідні налаштування NVDA.
1. Впевніться що налаштування Вашого скрінрідера дозволяють детально читати вміст термінала.
