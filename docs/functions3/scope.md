...
* в Python є наступні простори імен: вбудований, глобальний і локальний
* правило LEGB: пошук імен відбувається від локальної до вбудованої області видимості
* при використанні операції присвоєння ім'я вважається локальним. Цю поведінку можна змінити за допомогою операторів `global` та `nonlocal`.
-->
