...
то зрізи можна застосовувати і до них:
...
Зауважте: за допомогою зрізів ми завжди отримуємо нову послідовність, 
...
Реплікація також працює для списків і кортежів:
